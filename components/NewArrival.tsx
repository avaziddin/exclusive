...
const NewArrival: React.FC<NewArialProps> = ({ translation }) => {
    return (
        <>
            <div className="mb-[150px]">
                ...
                <div className="w-full gap-[2%] mt-[50px] flex h-hit">
                    ...
                    >
                        <div className="">
                        <Image className='m-auto absolute left-[10%] bottom-0 opacity-[.9]' src="/images/playstation.svg" alt="psFive" width={600} height={300} />
                        </div>
                        <div className="absolute bottom-[5%] left-[5%]">
                            <h1 className='text-[28px] font-semibold mb-[10px]'>PlayStation 5</h1>
                            <p className='mb-[10px]'>{translation.main.blandwh}</p>
                            <Link href="/">
                                <p className='border-b w-fit' >{translation.main.shopnow}</p>
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="w-[54%] flex flex-col gap-[3.9%]">
                        ...
                        >
                            <div className="absolute bottom-[10%] left-[4%] z-10">
                                <h1 className='text-[28px] whitespace-nowrap font-semibold mb-[10px]'>{translation.main.wmcol}</h1>
                                <p className='mb-[10px]'>{translation.main.featuredw}</p>
                                <Link href="/">
                                    <p className='text-[16px] border-b w-fit' >{translation.main.shopnow}</p>
                                </Link>
                            </div>
                            <div className="w-fit">
                            <Image className='opacity-[.9] rounded-lg' src="/images/woman.svg" alt="women" width={450} height={300} />
                            </div>
                        </div>
                        ...
                        <div className="relative overflow-hidden flex gap-[4%]">
                                ...
                                <div
                                    ...
                                    <div className="w-[70%] m-auto pt-[6.3%] pl-[5%] pb-[5%]">
                                        <Image className='cover opacity-[.9]' src="/images/frame.svg" alt="speckers" width={250} height={300} />
                                    </div>
                                    ...
                                    <div className="absolute bottom-[10%] left-[9%]">
                                        ...
                                        <p className='mb-[10px]'>{translation.main.amazon}</p>
                                        <Link href="/">
                                            <p className='text-[16px] border-b w-fit' >{translation.main.shopnow}</p>
                                        </Link>
                                    </div>
                                ...
                                <div
                                    ...
                                    <div className="w-[70%] m-auto pl-[5%]">
                                        <Image className='cover opacity-[.9]' src="/images/atir.svg" alt="speckers" width={250} height={300} />
                                    </div>

                                    <div className="absolute bottom-[10%] left-[9%]">
                                        <h1 className='text-[28px] whitespace-nowrap font-semibold mb-[10px]'>{translation.main.perfume}</h1>
                                        <p className='mb-[10px]'>{translation.main.gucci}</p>
                                        <Link href="/">
                                            <p className='text-[16px] border-b w-fit' >{translation.main.shopnow}</p>
                                        </Link>
                                    </div>
