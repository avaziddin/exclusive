...
export default async function About({ params: { lang }, }: { params: { lang: string }; }) {
    ...
    return (
        <Layout translation={translation}>
            <div className="flex gap-2 text-xl mt-20"> <Link href='/'><span className="text-gray-400">{translation.main.about.home}</span></Link><span className="text-black">/</span> <span className="text-black">{translation.main.about.about}</span></div>
            <div className="flex justify-between items-center text-black ">
                <div className="flex flex-col gap-10">
                    <h1 className="text-[60px] font-bold">{translation.main.about.ourstory}</h1>
                    <span>{translation.main.about.span1} </span>
                    <span>{translation.main.about.span2}</span>
                </div>
                <Image src="/images/duxtaro.svg" alt="duxtaro" width={720} height={10} />
            </div>

            <div className="flex justify-between mt-48 text-black">
                <div className="w-[270px] h-[230px] rounded-md border-gray-300 border-[3px] flex flex-col py-5 gap-3 items-center">
                ...
                <div className="w-[270px] h-[230px] text-white bg-red-500  rounded-md flex flex-col py-5 gap-3 items-center">
            ...
            <div className="flex justify-between mt-32">
                <div className="w-[370px] h-[570px] flex flex-col justify-between text-black">
                    <Image src="/images/tom.svg" alt="yag" width={370} height={1} />
                    <h1 className="text-[35px] font-bold mt-3">Tom Cruise</h1>
                    <span className="text-[22px]">{translation.main.about.yag}</span>
                ...
                <div className="w-[370px] h-[570px] flex flex-col justify-between text-black">
                    <Image src="/images/emma.svg" alt="yag" width={370} height={1} />
                    <h1 className="text-[35px] font-bold mt-3">Emma Watson</h1>
                    <span className="text-[22px]">{translation.main.about.du}</span>
                    <div className="flex gap-4">
                    <Image src="/images/Icon-Twitter (2).svg" alt="yag" width={30} height={1} />
                    <Image src="/images/icon-instagram.svg" alt="yag" width={30} height={1} />
                    <Image src="/images/in.svg" alt="yag" width={30} height={1} />    
                ...
                <div className="w-[370px] h-[570px] flex flex-col justify-between text-black">
                    <Image src="/images/will.svg" alt="yag" width={370} height={1} />
                    <h1 className="text-[35px] font-bold mt-3">Will Smith</h1>
                    <span className="text-[22px]">{translation.main.about.se}</span>
                    <div className="flex gap-4">
                    <Image src="/images/Icon-Twitter (2).svg" alt="yag" width={30} height={1} />
                    <Image src="/images/icon-instagram.svg" alt="yag" width={30} height={1} />
                    <Image src="/images/in.svg" alt="yag" width={30} height={1} />    
